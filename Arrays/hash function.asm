...
; (999 x double word) for collision data table + 3 bytes for alignment, totalling 
; 204064 bytes.
...
.L1:  mov   rax, 0
      ...
      lea   rdi, [rbp-83]
      call  hash      
      mov   di, [rbp-200065+rax*2]
      inc   di
      mov   [rbp-200065+rax*2], di

; prints the hash table
   
      xor   rbx, rbx
.L2:  movzx rdx, word [rbp-200065+rbx*2]
      cmp   dx, 0
      jz    .ze
      lea   rdi, [fmt]
      mov   esi, ebx
...
.L3:  movzx rcx, word [rbp-200065+rax*2]
      cmp   cx, 999
      cmovg cx, bx
      mov   edx, [rbp-204064+rcx*4]
      inc   edx
      mov   [rbp-204064+rcx*4], edx
      inc   rax
      cmp   rax, 99991
      jnz   .L3
